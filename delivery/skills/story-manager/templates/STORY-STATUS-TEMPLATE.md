...
| lld_review | | 等待单 Story 或小批次确认 |
| dev_ready | | LLD confirmed，依赖满足，文件无冲突 |
...
|----------|------------------|---------------|--------------|--------------|------|
| STORY-001 | `process/checks/CP5-STORY-001-...-LLD-IMPLEMENTABILITY.md` | `checkpoints/CP5-STORY-001-...-LLD.md` | `process/checks/CP6-STORY-001-...-CODING-DONE.md` | `process/checks/CP7-STORY-001-...-VERIFICATION-DONE.md` | 待填写 |

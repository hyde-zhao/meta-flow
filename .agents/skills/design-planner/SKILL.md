...
- 输入：`.workflow-meta/mfq/integration/logic-cases.md` + `.workflow-meta/mfq/m-analysis/ppdcs-annotation.md`
- 输出：`.workflow-meta/mfq/integration/design-plan.md`

## 前置条件

- [ ] 测试点整合完成（`.workflow-meta/mfq/integration/logic-cases.md` 存在）
- [ ] 测试数据已分配（`.workflow-meta/mfq/integration/test-data.md` 存在）
- [ ] PPDCS 特征标注已完成（`.workflow-meta/mfq/m-analysis/ppdcs-annotation.md` 存在）
...
写入 `.workflow-meta/mfq/integration/design-plan.md`（含 PPDCS 特征列）。
...
- [ ] 设计计划表包含 PPDCS 特征列
- [ ] 用户已确认设计计划
- [ ] 输出文件写入 `.workflow-meta/mfq/integration/design-plan.md`

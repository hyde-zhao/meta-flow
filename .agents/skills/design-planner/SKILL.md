...
- 输入：`.mfq-work/integration/logic-cases.md` + `.mfq-work/m-analysis/ppdcs-annotation.md`
...
- [ ] PPDCS 特征标注已完成（`.mfq-work/m-analysis/ppdcs-annotation.md` 存在）
...
写入 `.mfq-work/integration/design-plan.md`（含 PPDCS 特征列）。

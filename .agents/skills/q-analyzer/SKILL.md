...
- 输入：`.workflow-meta/mfq/m-analysis/test-points.md` + 场景文档
...
写入 `.workflow-meta/mfq/q-analysis/quality-test-points.md`：
...
- [ ] 输出文件写入 `.workflow-meta/mfq/q-analysis/quality-test-points.md`

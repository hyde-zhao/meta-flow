...
1. 创建 `.output/STATE.md`、`.output/REQUEST.md`、`.output/INPUT-INDEX.md`、`.output/CLARIFICATION-LOG.md`、`.output/stories/`、`.output/changes/`、`.output/packages/`
2. 扫描 `.input/` 并建立 `.output/INPUT-INDEX.md`
3. 引导用户填写 `REQUEST.md`
4. 初始化 `STATE.md`
...
| `documentation` | README.md + USER-MANUAL.md 已生成且包清单完整 | `delivered` | — | **⑤终验** |

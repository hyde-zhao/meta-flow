...
5. **输出隔离**：所有运行时状态和产物文件统一按层输出到 `process/`、`checkpoints/`、`delivery/`
...
1. 创建 `process/STATE.md`、`process/REQUEST.md`、`process/INPUT-INDEX.md`、`process/CLARIFICATION-LOG.md`、`process/stories/`、`process/changes/`、`delivery/scripts/`

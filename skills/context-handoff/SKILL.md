...
根据目标 Agent 的职责，从 `.meta-workflow/` 工作区中筛选最小必要上下文，并明确哪些内容不应加载，确保交接简洁且不越权。
...
- `AGENTS.md`：角色职责与阶段定义
- `.meta-workflow/process/STATE.md`：当前阶段、当前 Wave、活跃变更

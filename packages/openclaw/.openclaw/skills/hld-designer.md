...
基于已确认的 `REQUIREMENTS.md`、`USE-CASES.md` 和补充约束，输出一份**可直接进入人工评审**的 `.output/HLD.md`。文档必须能作为后续 Story 拆解和 LLD 设计的上游输入，而不是停留在概念讨论层。
...
| 文件 | 路径 | 说明 |
|------|------|------|
| HLD 文档 | `.output/HLD.md` | 供 meta-po 发起人工评审的高层设计文档 |

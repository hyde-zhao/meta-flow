...
def main():
    ...
    read_parser.add_argument("--output", "-o", default=None, help="输出图模型文件路径（默认 mfq/f-analysis/coupling-graph.json）")
    ...
    if args.command == "read":
        ...
        output = args.output or "mfq/f-analysis/coupling-graph.json"

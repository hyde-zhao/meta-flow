...
- 输入：`mfq/m-analysis/` + 耦合矩阵 Excel + 场景文档
- 输出：`mfq/f-analysis/` 目录下多个文件
...
1. 读取 `mfq/scenarios/confirmed-scenarios.md`
2. 分析每个场景涉及的功能点组合
...
输出合并后的图模型到 `mfq/f-analysis/coupling-graph.yaml`
